...
$jscomp.polyfill("Promise", function(k) {
    ...
    h.all = function(f) {
        ...
        return v.done ? l([]) : new h(function(z,
            ...
            var Q = [],
                u = 0;
            do Q.push(void 0), u++, l(v.value).callWhenSettled_(da(Q.length - 1), F), v = q.next(); while (!v.done)
        })
    };
    return h
}, "es6", "es3");
...
var DracoDecoderModule = function() {
    ...
    return function(n) {
            ...
            for (d = ""; b < c;) {
                ...
                if (g & 128) {
                    ...
                    if (192 == (g & 224)) d += String.fromCharCode((g & 31) << 6 | t);
                        ...
                        var W = e[b++] & 63;
                        g = 224 ==
                            (g & 240) ? (g & 15) << 12 | t << 6 | W : (g & 7) << 18 | t << 12 | W << 6 | e[b++] & 63;
        ...
        function v() {
            if (!fa && (Aa || ha)) {
                if ("function" === typeof fetch && !R.startsWith("file://")) return fetch(R, {
                ...
                if (qa) return new Promise(function(e, b) {
                    qa(R, function(c) {
                        e(new Uint8Array(c))
                    }, b)
                })
        ...
        } else if (Aa || ha) ha ? V = self.location.href : "undefined" !== typeof document && document.currentScript && (V = document.currentScript.src), k && (V = k), V = 0 !== V.indexOf("blob:") ? V.substr(0, V.replace(/[?#].*/, "").lastIndexOf("/") + 1) : "", cb = function(e) {
        ...
        (function() {
            ...
            if (a.instantiateWasm) try {
                ...
                return ca("Module.instantiateWasm callback failed with error: " + g), !1
            }(function() {
                return fa || "function" !== typeof WebAssembly.instantiateStreaming || R.startsWith("data:application/octet-stream;base64,") || R.startsWith("file://") || "function" !== typeof fetch ? c(b) :
                    fetch(R, {
                        credentials: "same-origin"
                    }).then(function(g) {
        ...
        var eb = a._emscripten_bind_VoidPtr___destroy___0 = function() {
            ...
            Ha = a._emscripten_bind_AttributeTransformData_AttributeTransformData_0 = function() {
                return (Ha = a._emscripten_bind_AttributeTransformData_AttributeTransformData_0 =
            ...
            Ia = a._emscripten_bind_GeometryAttribute_GeometryAttribute_0 = function() {
                return (Ia = a._emscripten_bind_GeometryAttribute_GeometryAttribute_0 =
            ...
            La = a._emscripten_bind_AttributeOctahedronTransform_AttributeOctahedronTransform_0 = function() {
                return (La = a._emscripten_bind_AttributeOctahedronTransform_AttributeOctahedronTransform_0 =
            ...
            Bb = a._emscripten_bind_AttributeOctahedronTransform___destroy___0 = function() {
                return (Bb =
                    a._emscripten_bind_AttributeOctahedronTransform___destroy___0 = a.asm.O).apply(null, arguments)
            },
            ...
            Db = a._emscripten_bind_PointCloud_num_points_0 = function() {
                return (Db = a._emscripten_bind_PointCloud_num_points_0 = a.asm.R).apply(null,
                    arguments)
            },
            ...
            Jb = a._emscripten_bind_Metadata___destroy___0 = function() {
                return (Jb = a._emscripten_bind_Metadata___destroy___0 =
                    a.asm.Z).apply(null, arguments)
            },
            ...
            Nb = a._emscripten_bind_Status___destroy___0 = function() {
                return (Nb = a._emscripten_bind_Status___destroy___0 =
            ...
            Xb = a._emscripten_bind_DracoInt16Array_GetValue_1 =
            function() {
            ...
            mc = a._emscripten_bind_MetadataQuerier_GetStringEntry_2 = function() {
                return (mc = a._emscripten_bind_MetadataQuerier_GetStringEntry_2 = a.asm.Ja).apply(null,
                    arguments)
            },
            ...
            Fc = a._emscripten_bind_Decoder_GetAttributeIntForAllPoints_3 = function() {
                return (Fc = a._emscripten_bind_Decoder_GetAttributeIntForAllPoints_3 =
            ...
            Ic = a._emscripten_bind_Decoder_GetAttributeInt16ForAllPoints_3 = function() {
                return (Ic = a._emscripten_bind_Decoder_GetAttributeInt16ForAllPoints_3 =
            ...
            Lc = a._emscripten_bind_Decoder_GetAttributeUInt32ForAllPoints_3 = function() {
                return (Lc = a._emscripten_bind_Decoder_GetAttributeUInt32ForAllPoints_3 =
            ...
            Oc = a._emscripten_bind_Decoder_GetEncodedGeometryType_Deprecated_1 = function() {
                return (Oc = a._emscripten_bind_Decoder_GetEncodedGeometryType_Deprecated_1 =
            ...
            Uc = a._emscripten_enum_draco_AttributeTransformType_ATTRIBUTE_QUANTIZATION_TRANSFORM = function() {
                return (Uc = a._emscripten_enum_draco_AttributeTransformType_ATTRIBUTE_QUANTIZATION_TRANSFORM =
            ...
            Xc = a._emscripten_enum_draco_GeometryAttribute_Type_POSITION = function() {
                return (Xc = a._emscripten_enum_draco_GeometryAttribute_Type_POSITION =
            ...
            $c = a._emscripten_enum_draco_GeometryAttribute_Type_TEX_COORD = function() {
                return ($c = a._emscripten_enum_draco_GeometryAttribute_Type_TEX_COORD =
            ...
            cd = a._emscripten_enum_draco_EncodedGeometryType_POINT_CLOUD = function() {
                return (cd = a._emscripten_enum_draco_EncodedGeometryType_POINT_CLOUD =
            ...
            db = a._malloc = function() {
                return (db = a._malloc = a.asm.Ub).apply(null,
                    arguments)
            };
        a._free = function() {
        ...
        S.prototype.transform_type = S.prototype.transform_type =
            function() {
                return hb(this.ptr)
            };
        ...
        H.prototype.InitFromAttribute = H.prototype.InitFromAttribute =
            function(b) {
                var c = this.ptr;
                b && "object" === typeof b && (b = b.ptr);
                return !!zb(c, b)
